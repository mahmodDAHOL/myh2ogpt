...
from gradio_themes import H2oTheme, SoftTheme, get_h2o_title, get_simple_title, \
    get_dark_js, get_heap_js, wrap_js_to_lambda, get_stategy_title, \
...
def go_gradio(**kwargs):
    ...
    queue = True
    allow_upload = True
    allow_upload_api = True

    kwargs.update(locals())
    brown_red = colors.Color(name="brown_red", c50="#a32020", c100="#a32020", c200="#a32020", c300="#a32020", c400="#a32020", c500="#a32020", c600="#a32020", c700="#a32020", c800="#a32020", c900="#a32020", c950="#a32020",)

    black = colors.Color(name="black", c50="#000000", c100="#000000", c200="#000000", c300="#000000", c400="#000000", c500="#000000", c600="#000000", c700="#000000", c800="#000000", c900="#000000", c950="#000000",)

    faded_red = colors.Color(name="Faded Red", c50="#D93954", c100="#D93954", c200="#D93954", c300="#D93954", c400="#D93954", c500="#D93954", c600="#D93954", c700="#D93954", c800="#D93954", c900="#D93954", c950="#D93954",)
    ...
    title = "Strategy&"
    demo = gr.Blocks(theme=theme, css=css_code, title="Strategy&gpt", analytics_enabled=False)
    ...
    with demo:
        ...
        description = ""
        gr.Markdown(f"{get_stategy_title(title, description)}")
        ...
        with normal_block:
            side_bar = gr.Column(elem_id="sidebar", scale=1, min_width=200, visible=True)
            ...
            with side_bar:
                with gr.Accordion("Chats", open=False, visible=False):
                    radio_chats = gr.Radio(value=None, label="Saved Chats", show_label=False,
                                           ...
                                           type='value')
                upload_visible = True
                # with gr.Accordion("Choose file(s)", open=False, visible=True):
                #         # if kwargs['langchain_mode'] in langchain_modes_non_db:
                #         #     dlabel1dlabel1 = 'Choose Resources->Collections and Pick Collection'
                #         #     active_collection = gr.Markdown(value="#### Not Chatting with Any Collection\n%s" % dlabel1dlabel1)
                #         # else:
                #         #     dlabel1dlabel1 = 'Select Subset of Document(s) for Chat with Collection: %s' % kwargs['langchain_mode']
                ...
                #                                     label="Select Subset of Documents",
                ...
                row_doc_track = gr.Row(visible=True)
                with row_doc_track:
                    if kwargs['langchain_mode'] in langchain_modes_non_db:
                    ...
                    text_doc_count = gr.Textbox(lines=3, label="Doc Counts", value=doc_counts_str,
                                                visible=True)
                    text_file_last = gr.Textbox(lines=1, label="Newest Doc", value=None, visible=True)
                    text_viewable_doc_count = gr.Textbox(lines=2, label=None, visible=False)
            col_tabs = gr.Column(elem_id="col-tabs", scale=10)
            with col_tabs:
                ####################>>>>
                text_output_nochat = gr.HTML(label=output_label0, visible=False)
                with gr.Row():
                    # NOCHAT
                    ...
                    iinput_nochat = gr.Textbox(lines=4, label="Input context for Instruction",
                                                ...
                                                value=kwargs['iinput'],
                                                visible=False)
                    submit_nochat = gr.Button("Submit", size='sm', visible=False)
                    flag_btn_nochat = gr.Button("Flag", size='sm', visible=False)
                ...
                doc_selection_tab = gr.TabItem("Document Selection",visible=False) \
                ...
                with gr.Tabs(visible=False) as tabs:
                    doc_view_tab = gr.TabItem("Document Viewer",visible=False) \
                    ...
                    chat_tab = gr.TabItem("Chat History",visible=False) \
                    ...
                    with chat_tab:
                        ...
                        chat_exception_text = gr.Textbox(value="", visible=True, label='Chat Exceptions',
                                                        interactive=False)
                    expert_tab = gr.TabItem("Expert",visible=False) \
                    ...
                    models_tab = gr.TabItem("Models",visible=False) \
                        ...
                        with gr.Row(visible=not kwargs['model_lock']):
                            ...
                            with gr.Row():
                                add_model_lora_server_button = gr.Button("Add new Model, Lora, Server url:port", scale=0,
                                                                        ...
                                                                        size='sm', interactive=not is_public)
                    system_tab = gr.TabItem("System",visible=False) \
                    ...
                    tos_tab = gr.TabItem("Terms of Service",visible=False) \
                    ...
                    login_tab = gr.TabItem("Login",visible=False) \
